...
- Task id: `product-inbox-2026-03-15-communications-update-content-editorial--marketing-review`
- Task type: `review`
- Owner: `marketing-director`
- Priority: `high`
- Generated: `2026-03-22T18:20:36.816Z`
- Title: Review product-inbox-2026-03-15-communications-update-content-editorial
...
### .agents/drafts/generated/product-inbox-2026-03-15-communications-update-content-editorial-content-editorial.md

# Content Editorial Output

- Task id: `product-inbox-2026-03-15-communications-update-content-editorial`
- Task type: `product-inbox-intake`
- Owner: `content-editorial`
- Priority: `high`
- Generated: `2026-03-22T18:20:36.763Z`
- Title: Product inbox intake: 2026-03-15-communications-update

## Task Intent

Review this product handoff, extract only safe public-facing implications, and produce role-specific draft guidance under the LawOps marketing rules. Focus on blog and long-form editorial opportunities worth drafting. Treat internal communication foundations conservatively and do not present them as polished public product capabilities.
...
# Content Editorial Agent Charter

Purpose:

- own blog strategy, authority-building content, editorial cadence, and repurposing plans

Owns:

- blog themes
- editorial calendar
- thought leadership angle selection
- long-form content structure

Must do:

- publish content that teaches operational maturity in law firms
- build trust through specificity, not fluff
- create pieces that can be repurposed into social, outbound, and sales enablement

Stop conditions:

- topics are too broad to reach Estate Planning operators
- articles drift into generic legal marketing advice
- content exists only to fill a calendar and says nothing new

### Recent Product Inbox Files

- `.agents/product/inbox/2026-03-15-product-clarification-communications-claims.md`
- `.agents/product/inbox/2026-03-22-dev-ha...
[truncated]
