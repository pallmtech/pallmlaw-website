...
- Task id: `product-inbox-2026-03-15-communications-update-website-conversion--marketing-review`
- Task type: `review`
- Owner: `marketing-director`
- Priority: `high`
- Generated: `2026-03-22T18:20:36.833Z`
- Title: Review product-inbox-2026-03-15-communications-update-website-conversion
...
### .agents/drafts/generated/product-inbox-2026-03-15-communications-update-website-conversion-website-conversion.md

# Website Conversion Output

- Task id: `product-inbox-2026-03-15-communications-update-website-conversion`
- Task type: `product-inbox-intake`
- Owner: `website-conversion`
- Priority: `high`
- Generated: `2026-03-22T18:20:36.782Z`
- Title: Product inbox intake: 2026-03-15-communications-update

## Task Intent

Review this product handoff, extract only safe public-facing implications, and produce role-specific draft guidance under the LawOps marketing rules. Focus on page structure, section implications, and CTA-safe website changes. Treat internal communication foundations conservatively and do not present them as polished public product capabilities.
...
# Website Conversion Agent Charter
...
- CTA strategy
- section sequencing
- credibility and objection blocks
...
- offer sections
- CTA placement and form strategy
